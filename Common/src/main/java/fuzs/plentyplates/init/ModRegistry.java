...
import fuzs.plentyplates.world.level.block.ModPressurePlateBlock;
...
public class ModRegistry {
    ...
    public static final RegistryReference<Block> PRESSURE_PLATE_BLOCK = REGISTRY.registerBlockWithItem("pressure_plate", () -> new ModPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE_PRESSURE_PLATE)), CreativeModeTab.TAB_REDSTONE);
